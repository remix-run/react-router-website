...
INSERT INTO "new_Doc" ("description", "disabled", "filePath", "html", "id", "lang", "md", "order", "published", "siblingLinks", "title", "versionId") SELECT "description", "disabled", "filePath", "html", "id", "lang", "md", "order", "published", "siblingLinks", "title", "versionId" FROM "Doc";
DROP TABLE "Doc";
