  ...
  (props, ref) => {
    ...
    return (
      <input
        ...
        className={cx(
          className,
          `appearance-none rounded h-5 w-5 form-check text-transparent checked:text-blue-500
           bg-white bg-opacity-[0.15] hover:bg-opacity-[0.18]
           border ${
...
const Radio = React.forwardRef<HTMLInputElement, RadioProps>((props, ref) => {
  ...
  return (
    <input
      ...
      className={cx(
        className,
        `appearance-none rounded-full h-5 w-5 form-dot text-transparent checked:text-blue-500
           bg-white bg-opacity-[0.15] hover:bg-opacity-[0.18]
           border ${
             validationState === "invalid"
               ? "border-red-500 focus:border-red-500"
...
function getFieldClassNames({
  ...
  return cx(
    ...
    placeholder-gray-600 text-base ${
      validationState === "invalid" ? "text-red-500" : "text-white"
    }
    focus:outline-none focus:ring-2 ${
      validationState === "invalid"
        ? "focus:ring-red-500"
